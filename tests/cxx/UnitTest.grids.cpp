...
DREAM::FVM::Grid *UnitTest::InitializeGridRCylPXi(
    ...
    const real_t pMin, const real_t pMax, bool avalancheChiuHarvey, real_t pInMaxCH, real_t pCutCH
) {
    auto *crgg = new DREAM::FVM::CylindricalRadialGridGenerator(nr, B0);
    auto *rg   = new DREAM::FVM::RadialGrid(crgg);
    ...
    auto *grid = new DREAM::FVM::Grid(rg, mg, avalancheChiuHarvey, pInMaxCH, pCutCH);
...
DREAM::FVM::Grid *UnitTest::InitializeGridGeneralRPXi(
    ...
    bool avalancheChiuHarvey, real_t pInMaxCH, real_t pCutCH, 
    ...
    auto *grid = new DREAM::FVM::Grid(rg, mg, avalancheChiuHarvey, pInMaxCH, pCutCH, 0, q_method_trapped);
    grid->Rebuild(0);
    return grid;
}
