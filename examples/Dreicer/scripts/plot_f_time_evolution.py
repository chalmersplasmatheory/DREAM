...
# 保存图像到文件夹
file_path = os.path.join(output_dir, 'f_time_evolution.png')
...
plt.tight_layout()
file_path_detail = os.path.join(output_dir, 'f_time_detail.png')
...
file_path_xi = os.path.join(output_dir, 'f_pitch_comparison.png')
