...
# Save figure
plt.tight_layout()
plt.savefig('../figures/dreicer_p_perp_parallel_scatter.png', dpi=300)
plt.show()
...
# Save figure
plt.tight_layout()
plt.savefig('../figures/dreicer_p_perp_parallel_contour.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig('../figures/dreicer_p_perp_parallel_evolution.png', dpi=300)
plt.show()
