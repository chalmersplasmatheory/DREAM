...
rT = np.linspace(0, max(ds.radialgrid.r_f), len(ds.eqsys.T_cold.temperature[0,:]))
n0 = 4e18*np.ones(len(ds.radialgrid.r_f))

# rn, n0, rT, T0 = ...  get profiles of density and temperature
ds.eqsys.f_hot.setInitialProfiles(rn0=r, n0=n0, rT0=rT, T0=ds.eqsys.T_cold.temperature[0,:])
