...
axes[0].plot(nps, rr_CENTRED_pscan, label='Centered', linewidth=2, color='blue', linestyle='dotted')
...
axes[1].plot(nxis, rr_CENTRED_xiscan, label='Centered',linewidth=2, color='blue', linestyle='dotted')
