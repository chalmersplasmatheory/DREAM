...
ds2.save('injection_restart_settings_nShard'+str(nShard)+'kp'+str(kp)+''+filename_ending+'.h5')
runiface(ds2, 'output_restart_injection_nShard'+str(nShard)+'kp'+str(kp)+''+filename_ending+'.h5', quiet=False)
