...
# 配置输出文件名称
output_base_name = 'output18'  # 修改这一行就能改变所有输出文件名                                                                                                                                                       
...
n = 2e21    # Electron density (m^-3)
T = 5e3     # Temperature (eV)
...
ds.eqsys.n_i.addIon(name='Ar', Z=18, iontype=Ions.IONS_PRESCRIBED, Z0=18, n=n)
#ds.eqsys.n_i.addIon(name='Ar', Z=18, iontype=Ions.IONS_PRESCRIBED_NEUTRAL, n=n)
