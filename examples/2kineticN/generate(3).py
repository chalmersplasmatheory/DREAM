...
if os.path.exists(output_result_file):
    try:
        ...
        print(f"已删除现有文件: {output_result_file}")
...
ds.eqsys.n_i.addIon(name='Ar', Z=18, iontype=Ions.IONS_PRESCRIBED,Z0=2, n=n)
#ds.eqsys.n_i.addIon(name='He', Z=2, iontype=Ions.IONS_PRESCRIBED_FULLY_IONIZED, n=n) 
