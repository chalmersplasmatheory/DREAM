...
void SimulationGenerator::DefineOptions_f_hot(Settings *s) {
    ...
    s->DefineSetting(MODULENAME "/pThresholdMode", "Unit of provided threshold momentum pThreshold (thermal or mc).", (int_t) FVM::MomentQuantity::P_THRESHOLD_MODE_THERMAL);
