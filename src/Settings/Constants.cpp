...
const char *OptionConstants::UQTY_K_HOT             = "K_hot";
...
const char *OptionConstants::UQTY_POT_UPS_0_HOT     = "UPS_0_HOT";
const char *OptionConstants::UQTY_POT_UPS_1_HOT     = "UPS_1_HOT";
const char *OptionConstants::UQTY_POT_UPS_2_HOT     = "UPS_2_HOT";
const char *OptionConstants::UQTY_POT_PI_0_HOT      = "PI_0_HOT";
const char *OptionConstants::UQTY_POT_PI_1_HOT      = "PI_1_HOT";
...
const char *OptionConstants::UQTY_W                 = "W";
...
const char *OptionConstants::UQTY_K_HOT_DESC        = "Heat magnitude";
...
const char *OptionConstants::UQTY_POT_UPS_0_HOT_DESC= "Braams-Karney potential Y_0 on the hot grid [m^-3]";
const char *OptionConstants::UQTY_POT_UPS_1_HOT_DESC= "Braams-Karney potential Y_1 on the hot grid [m^-3]";
const char *OptionConstants::UQTY_POT_UPS_2_HOT_DESC= "Braams-Karney potential Y_2 on the hot grid [m^-3]";
const char *OptionConstants::UQTY_POT_PI_0_HOT_DESC = "Braams-Karney potential PI_0 on the hot grid [m^-3]";
const char *OptionConstants::UQTY_POT_PI_1_HOT_DESC = "Braams-Karney potential PI_1 on the hot grid [m^-3]";
...
const char *OptionConstants::UQTY_W_DESC        = "Electron energy density [J/m^3]";
