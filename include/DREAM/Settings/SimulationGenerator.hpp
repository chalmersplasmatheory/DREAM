...
namespace DREAM {
    ...
    public:
        ...
        static void ConstructEquation_T_i(EquationSystem*, Settings*,struct OtherQuantityHandler::eqn_terms *oqty_terms);
        static void ConstructEquation_T_i_trivial(EquationSystem*, Settings*);
        static void ConstructEquation_T_i_selfconsistent(EquationSystem*, Settings*, struct OtherQuantityHandler::eqn_terms *oqty_terms);
