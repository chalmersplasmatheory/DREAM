...
enum eqterm_avalanche_mode {                        // Avalanche generation is...
    ...
    EQTERM_AVALANCHE_MODE_BOLTZMANN_KNOCK_ON = 5    // modelled with the field-particle piece of the full boltzmann collision integral 
};
