#ifndef _DREAM_EQUATIONS_FROZEN_CURRENT_COEFFICIENT_D_HPP
#define _DREAM_EQUATIONS_FROZEN_CURRENT_COEFFICIENT_D_HPP

#include "FVM/Equation/EquationTerm.hpp"
#include "FVM/Interpolator1D.hpp"

namespace DREAM {
	class FrozenCurrentCoefficient_D : public FVM::EquationTerm {
	protected:
	...
	public:
		FrozenCurrentCoefficient_D(
			FVM::Grid*, FVM::Interpolator1D*,
			FVM::UnknownQuantityHandler*
		);
		virtual ~FrozenCurrentCoefficient_D();
...
#endif/*_DREAM_EQUATIONS_FROZEN_CURRENT_COEFFICIENT_D_HPP*/
