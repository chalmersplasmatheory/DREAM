 ...
 */
template<typename T>
DREAM::TransportPrescribedBC<T>::TransportPrescribedBC(
    DREAM::FVM::Grid *grid, DREAM::TransportPrescribed<T> *tt
 ...
 */
template<typename T>
void DREAM::TransportPrescribedBC<T>::AddToJacobianBlock(
 ...
 */
template<typename T>
void DREAM::TransportPrescribedBC<T>::AddToMatrixElements(
 ...
 */
template<typename T>
void DREAM::TransportPrescribedBC<T>::AddToVectorElements(
 ...
 */
template<typename T>
void DREAM::TransportPrescribedBC<T>::__SetElements(
    ...
    const real_t *coeff = this->transportOperator->GetCoefficient(ir+1);
