...
/*
        static const std::function<real_t(real_t,real_t,real_t,real_t)> 
            BA_FUNC_UNITY = [](real_t, real_t, real_t,real_t )
                {return 1;},
...
*/
        static real_t BA_FUNC_UNITY(real_t,real_t,real_t,real_t)
            {return 1;}
        static real_t BA_FUNC_XI(real_t xiOverXi0,real_t,real_t,real_t)
            {return xiOverXi0;}
        static real_t BA_FUNC_XI_SQUARED_OVER_B(real_t xiOverXi0,real_t BOverBmin,real_t,real_t)
            {return xiOverXi0*xiOverXi0/BOverBmin;}
        static real_t BA_FUNC_B_CUBED(real_t, real_t BOverBmin, real_t,real_t )
            {return BOverBmin*BOverBmin*BOverBmin;}
        static real_t BA_FUNC_XI_SQUARED_B_SQUARED(real_t xiOverXi0, real_t BOverBmin, real_t,real_t )
            {return BOverBmin*BOverBmin*xiOverXi0*xiOverXi0;}
    ...
    private:
        ...
        void SetBounceAverage(real_t **&BA_quantity, std::function<real_t(real_t,real_t,real_t,real_t)> F, const int_t *Flist, fluxGridType fluxGridType);
        void SetBounceAveragePXi(real_t **&BA_quantity, std::function<real_t(real_t,real_t,real_t,real_t)> F, const int_t *Flist, fluxGridType fluxGridType);
        void DeallocateBAvg();
        void InitializeBAvg(
    ...
    public:
        ...
        real_t CalculateBounceAverage(len_t ir, len_t i, len_t j, fluxGridType fluxGridType, std::function<real_t(real_t,real_t,real_t,real_t)> F, const int_t *Flist=nullptr);
        real_t CalculateFluxSurfaceAverage(len_t ir, fluxGridType fluxGridType, std::function<real_t(real_t,real_t,real_t)> F, const int_t *Flist=nullptr);
