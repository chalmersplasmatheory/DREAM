...
namespace DREAM::FVM {
    ...
    public:
        ...
        real_t EvaluateAvalancheCHBounceAverage(len_t ir, real_t p_l, real_t p_u, /*real_t p_max,*/ real_t xi_l, real_t xi_u,  fluxGridType fgt, /*real_t Vp, real_t VpVol,*/ int_t RESign = 1);

    
    private: 
        struct avParams {real_t xi0; real_t gamma; int_t iTerm; int_t RESign;};
        static real_t BA_CH(real_t xiOverXi0, real_t BOverBmin, real_t, real_t, void *par);
        struct intXiParams {len_t ir; fluxGridType fgt; real_t gamma; /*real_t gamma_max;*/ int_t RESign; int_t iTerm; FluxSurfaceAverager *FSA;};
        ...
        static real_t integrandP(real_t p, void *par);
        // TODO: Remove
