#ifndef _DREAM_FVM_EQUATION_BOUNDARY_CONDITION_P_XI_EXTERNAL_LOWER_HPP
#define _DREAM_FVM_EQUATION_BOUNDARY_CONDITION_P_XI_EXTERNAL_LOWER_HPP
...
namespace DREAM::FVM::BC {
    class PXiExternalKineticLower : public BoundaryCondition {
    private:
...
#endif/*_DREAM_FVM_EQUATION_BOUNDARY_CONDITION_P_XI_EXTERNAL_LOWER_HPP*/
