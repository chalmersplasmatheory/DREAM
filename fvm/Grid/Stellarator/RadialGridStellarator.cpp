 ...
 */
bool RadialGridStellarator::Rebuild(const real_t t) {
 ...
 */
void RadialGridStellarator::SetMagneticExtremumData(
 ...
 * generated by a RadialGridGeneratorStellarator.
 */
void RadialGridStellarator::SetReferenceMagneticFieldData(
    ...
    this->BpolIOverR0    = BpolIOverR0;
    this->BpolIOverR0_f  = BpolIOverR0_f;
...
void RadialGridStellarator::SetStellaratorData(
 ...
 */
void RadialGridStellarator::RebuildFluxSurfaceAveragedQuantities(){
 real_t 
    ...
    *FSA_BdotGradphi   = nullptr,
    *FSA_BdotGradphi_f = nullptr, 
    *FSA_gttOverJ2   = nullptr,
    *FSA_gttOverJ2_f = nullptr,
 ...
 */
void RadialGridStellarator::SetFluxSurfaceAverage(real_t *&FSA_quantity, real_t *&FSA_quantity_f, real_t(*F)(real_t,real_t,real_t,real_t,void*), void *par, const int_t *Flist){
 ...
 */
real_t RadialGridStellarator::effectivePassingFractionIntegrand(real_t x, void *p){
 ...
 */
void RadialGridStellarator::SetEffectivePassingFraction(real_t *&EPF, real_t *&, real_t *FSA_B2, real_t*){
 ...
 * Set flux surface averages
 effectivePassingFraction,effectivePassingFraction_f,
        ...
        FSA_gttOverJ2, FSA_gttOverJ2_f, FSA_gtpOverJ2, FSA_gtpOverJ2_f
 */
void RadialGridStellarator::InitializeFSAvg(
