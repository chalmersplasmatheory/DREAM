...
\end{align}
whereas the the pitch integral should ideally be evaluated with an accurate quadrature that can handle the logarithmic singularity on the trapped-boundary and captures the value within a small error.
