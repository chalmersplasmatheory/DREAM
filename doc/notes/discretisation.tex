...
\end{comment}
    ...
    before convergence is reached. In some situation, convergence may be accelerated (or restored)
    ...
    according to the scheme chosen and $\delta_\text{prev}$ the coefficient in the previous time step
    (or iteration of the non-linear solver). Sometimes a value of $\eta \approx 0.9$ helps a lot -- too low
