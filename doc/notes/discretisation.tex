...
\end{comment}
    ...
    \end{align}
    Although SMART can often be slightly more accurate than MUSCL by staying closer to the accurate 
    QUICK scheme ($\psi=(1+3r)/4$), it tends to require a higher number of iterations than MUSCL 
    before convergence is reached, which can often be prohibitive.
