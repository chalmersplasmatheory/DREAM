...
For electron impact ionization by the kinetic electrons, we will use the Garland model for the integrated ionization cross section. Atomic data for the binding energy of electrons in each shell of all ionization states of impurities from $Z=1$ to $Z=30$ is given in [W Lotz, \emph{Subshell Binding Energies of Aoms and Ions from Hydrogen to Zinc}, Journal of the Optical Society of America {\bf 58} (1968)]. We ignore fine structure within the shells (which split the p-shell energy levels by $\sim 1\%$).
