...
\begin{align}
\phi = G\left[ \varphi + \frac{1}{2N_c}\left(\frac{R}{R_c}\right)^{N_c}\sin (N_c\varphi) \right],
\end{align}
with $G$ constant.
...
\begin{align}
\b{B}_c = G\left[ \left(1+ \frac{1}{2}\left(\frac{R}{R_c}\right)^{N_c} \cos(N_c \varphi) \right)\nabla\varphi + \frac{1}{2} \left(\frac{R}{R_c}\right)^{N_c-1} \sin(N_c\varphi)\frac{1}{R_c}\nabla R \right].
\end{align}
...
&=\frac{G}{2R_c} \left(\frac{R}{R_c}\right)^{N_c-1} \sin(N_c\varphi)\frac{\nabla R \cdot \nabla r}{|\nabla r|} \nonumber \\
&=\frac{G}{2R_c} \left(\frac{R}{R_c}\right)^{N_c-1} \frac{R}{\mathcal{J}}\frac{\partial z}{\partial \theta} \frac{\sin(N_c\varphi)}{|\nabla r|} \nonumber \\
&=\frac{G}{2\mathcal{J}} \left(\frac{R}{R_c}\right)^{N_c}  \frac{\sin(N_c\varphi)}{|\nabla r|} r\kappa \cos\theta.
\end{align}
...
. In the cylindrical limit, $R/R_c \to 1$ and $N_c \varphi = 2\pi z/L_c$ where $L_c$ is the spacing of the coils and $z$ the distance along the symmetry axis.
