...
=  - \frac{B}{R} \frac{\partial R}{\partial \theta} + \frac{\psi'}{2 B R^2} \frac{\partial |\nabla r|^2}{\partial \theta}.
\end{align}
...
&= \frac{1}{\pi p^2v \partial \psi/\partial r} \int \rd \varphi \oint \rd\theta  \,  \sqrt{g} \nonumber \\
&= \frac{\mathcal{V}'}{2\pi^2 p^2 v \partial \psi/\partial r}
\end{align}
in $(p,\,\lambda)$ coordinates. In $(p,\,\xi_0)$, it instead takes the form
\begin{align}
\tau_B(r,\,p,\,\xi_0) &= \frac{B\sub{min}\mathcal{V}'}{4\pi^2  \xi_0  p^2 v \partial \psi/\partial r}.
\end{align}
...
\begin{align}
q R_0 &=  \frac{V'^2}{(2\pi)^4R_0^2} \frac{G(r)}{\mu_0 I R_0} \left\langle \frac{R_0^2}{R^2}\right\rangle\left\langle|\nabla r|^2 \frac{R_0^2}{R^2}\right\rangle.
\end{align}
...
&= \int \frac{1}{2\mu_0}| \nabla \varphi \times \nabla \psi |^2 \,\rd\b{x} \nonumber \\
&= \int \frac{1}{2\mu_0}\frac{\psi'^2 |\nabla r|^2}{R^2} \,\rd\b{x} \nonumber \\
&= \int  \frac{1}{2\mu_0}\psi'^2 V' \left\langle  \frac{|\nabla r|^2}{R^2}  \right\rangle  \, \rd r \nonumber \\
&= 2\pi^2 \int \frac{\partial \psi}{\partial r} I(r) \, \rd r,
\end{align}
where in the last line we inserted Ampere's law from above. Integrating by parts, throwing the boundary term (presumably because we could in principle integrate to ``infinity'' where we define $\psi=0$), we find
\begin{align}
W\sub{pol} &= -2\pi^2\int \psi \frac{\partial I}{\partial r} \, \rd r \nonumber \\
&=-\pi \int_0^a V' G(r)\left\langle\frac{1}{R^2}\right\rangle \frac{j_\parallel}{B}\psi \,\rd r,
\end{align}
