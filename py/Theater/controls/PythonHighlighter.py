...
# With modifications by Mathias Hoppe
...
STYLES = {
	...
	'brace': format('#F92672'),
	'defclass': format('#66D9EF', 'bold'),	# Method declaration
	'classes': format('#66D9EF', 'bold'),	# Class declaration
	'Qtclass': format('white', 'bold'),
	'string': format('#E6DB74'),
	'string2': format('#7E8E91', 'italic'),
	'comment': format('#75715E'),
	'self': format('#D63030', 'italicbold'),
	'selfnext': format('#FF0000'),
	'Qnext': format('#FFFFFF'),
